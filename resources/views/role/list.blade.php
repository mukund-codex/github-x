        ...
        <div class="mt-4 flow-root">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    ...
                    <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Roles and permissions are manageable by Permission Seeder. Below is read only table. Super Admin role by default bypass all permissions</p>
                </div>
            </div>
                ...
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-700">
                        ...
                        <tr class="divide-x divide-gray-200 dark:divide-gray-800">
                            <th scope="col"
                                class="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-gray-900 dark:text-gray-100">Name
                            </th>
                            <th scope="col"
                                class="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-gray-900 dark:text-gray-100 sm:pr-0">Can
                            </th>
                        </tr>
                        </thead>
